...
void RenderSystem::LoadStaticObjects(
    RenderSystem::RenderListIterator renderListBegin,
    ...
    while (begin != renderListEnd) {
        ...
        std::vector<ShaderStage> stages = {
            {std::filesystem::current_path() / "../../" /
                 "resource/shader"/ name/ (name + ".frag"),
             "fragment"},
            {std::filesystem::current_path() / "../../" /
                 "resource/shader"/ name/ (name + ".vert"),
             "vertex"}};
        auto shaderProgram =
            GLShaderProgramFactory::createShaderProgram(name, stages);
...
void RenderSystem::renderObjectsWithTextures(
    RenderSystem::RenderListIterator renderListBegin,
...
void RenderSystem::renderObjectsNoTextures(
...
void RenderSystem::setupTextureSamplers() {
    ...
    glSamplerParameteri(m_samplerTexture, GL_TEXTURE_MIN_FILTER,
